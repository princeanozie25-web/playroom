...
| #      | Slice                             | Delivers                                                                                                                                                                                                                                                                                | Builds on                                                     | State                              |
| ------ | --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ---------------------------------- |
| **C1** | **Execution Gate (Rex-inspired)** | Host file/git/shell ops pass a policy check before running — a remote worker does not get a raw shell just because a machine connected. Invariant #7 FALSE → TRUE                                                                                                                       | A1 + the Action Gateway (`executeCommand`+`evaluate`, exists) | Not started                        |
| **C2** | **Local Node**                    | The trusted bridge to a user's machine — lease/heartbeat, capability scoping, revocation, reconnect                                                                                                                                                                                     | C1                                                            | Not started                        |
