...
Recorded take: **take 10**, 54.80s, five beats, one continuous take, production build — re-shot
after S1.3b on 27 Jul 2026, through a front door that now checks room membership. **Take 11 is a six-beat variant** (61.60s) that adds the handoff; it is
